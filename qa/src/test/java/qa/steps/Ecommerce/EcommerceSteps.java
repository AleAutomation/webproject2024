...
public class EcommerceSteps extends BaseTest{
	...
	public void i_make_a_purchase_using_performance_glitch_user(DataTable dataTable)throws Throwable {
	    List<List<String>> getLoginList = dataTable.asLists(String.class);
	    String userLogin = getLoginList.get(1).get(0);
	    String passwordLogin = getLoginList.get(1).get(1);
	    loginPage.loginMarketplace(userLogin, passwordLogin);
	...
	public void i_choose_some_products_to_the_cart(DataTable dataTable)throws Throwable {
		List<List<String>> productsList = dataTable.asLists(String.class);
		ecommerceList.selecionarProdutosLista(productsList);
		int qtdProdutoCarrinho = ecommerceList.obterQtdProdutosAddCarrinho();
		Assert.assertEquals(productsList.size(), qtdProdutoCarrinho);
	...
	public void fill_my_infos_correctly(DataTable dataTable)throws Throwable {
		List<List<String>> getcheckout = dataTable.asLists(String.class);
		String primeiroNome = getcheckout.get(1).get(0);
		String ultimoNome = getcheckout.get(1).get(1);
		String codPostal = getcheckout.get(1).get(2);
	...
	public void i_click_on_button_cancel_and_validate_how_long_time_it_took()throws Throwable {
	...
	public void i_going_to_use_performance_glitch_user(DataTable dataTable)throws Throwable {
	    List<List<String>> getLoginList = dataTable.asLists(String.class);
	    String userLogin = getLoginList.get(1).get(0);
	    String passwordLogin = getLoginList.get(1).get(1);
	    loginPage.loginMarketplace(userLogin, passwordLogin);
	...
	public void i_add_my_wish_products_to_the_cart(io.cucumber.datatable.DataTable dataTable)throws Throwable {
		List<List<String>> productsList = dataTable.asLists(String.class);
		ecommerceList.selecionarProdutosLista(productsList);
		int qtdProdutoCarrinho = ecommerceList.obterQtdProdutosAddCarrinho();
		Assert.assertEquals(productsList.size(), qtdProdutoCarrinho);
	...
	public void i_click_on_button_continue_to_shopping_and_validate_how_long_time_it_took()throws Throwable {
	...
	public void i_want_to_make_a_purchase_using_performance_glitch_user(DataTable dataTable)throws Throwable {
	    List<List<String>> getLoginList = dataTable.asLists(String.class);
	    String userLogin = getLoginList.get(1).get(0);
	    String passwordLogin = getLoginList.get(1).get(1);
	    loginPage.loginMarketplace(userLogin, passwordLogin);
	...
	public void i_add_products_to_the_cart(io.cucumber.datatable.DataTable dataTable)throws Throwable {
		List<List<String>> productsList = dataTable.asLists(String.class);
		ecommerceList.selecionarProdutosLista(productsList);
		int qtdProdutoCarrinho = ecommerceList.obterQtdProdutosAddCarrinho();
		Assert.assertEquals(productsList.size(), qtdProdutoCarrinho);
	...
	public void fill_my_the_infos_correctly(io.cucumber.datatable.DataTable dataTable)throws Throwable {
		List<List<String>> getcheckout = dataTable.asLists(String.class);
		String primeiroNome = getcheckout.get(1).get(0);
		String ultimoNome = getcheckout.get(1).get(1);
		String codPostal = getcheckout.get(1).get(2);
	...
	public void i_click_on_button_back_home_and_validate_how_long_time_it_took()throws Throwable {
		gerarScreenshot(5);
		checkoutOverview.clicarFinish();
		Assert.assertEquals("Thank you for your order!", checkoutOverview.validarMsgFinishPurchase());
		gerarScreenshot(6);
	...
	public void i_want_to_make_a_purchase_using_error_user(DataTable dataTable)throws Throwable {
	    List<List<String>> getLoginList = dataTable.asLists(String.class);
	    String userLogin = getLoginList.get(1).get(0);
	    String passwordLogin = getLoginList.get(1).get(1);
	    loginPage.loginMarketplace(userLogin, passwordLogin);
	...
	public void i_put_my_products_to_the_cart(DataTable dataTable)throws Throwable {
		List<List<String>> productsList = dataTable.asLists(String.class);
		ecommerceList.selecionarProdutosLista(productsList);
		int qtdProdutoCarrinho = ecommerceList.obterQtdProdutosAddCarrinho();
		Assert.assertEquals(productsList.size(), qtdProdutoCarrinho);
	...
	public void fill_in_the_address(io.cucumber.datatable.DataTable dataTable)throws Throwable {
		List<List<String>> getcheckout = dataTable.asLists(String.class);
		String primeiroNome = getcheckout.get(1).get(0);
		String ultimoNome = getcheckout.get(1).get(1);
		String codPostal = getcheckout.get(1).get(2);
	...
	public void i_make_a_purchase_using_error_user(DataTable dataTable)throws Throwable {
	    List<List<String>> getLoginList = dataTable.asLists(String.class);
	    String userLogin = getLoginList.get(1).get(0);
	    String passwordLogin = getLoginList.get(1).get(1);
	    loginPage.loginMarketplace(userLogin, passwordLogin);
	...
	public void i_choose_products_to_the_cart(DataTable dataTable)throws Throwable {
		List<List<String>> productsList = dataTable.asLists(String.class);
		ecommerceList.selecionarProdutosLista(productsList);
		int qtdProdutoCarrinho = ecommerceList.obterQtdProdutosAddCarrinho();
		Assert.assertEquals(productsList.size(), qtdProdutoCarrinho);
	...
	public void try_to_fill_in_the_address(DataTable dataTable)throws Throwable {
		List<List<String>> getcheckout = dataTable.asLists(String.class);
	...
	public void the_system_should_allow_me_fill_all_inputs()throws Throwable {
	...
	public void i_make_a_log_in_using_visual_user(DataTable dataTable)throws Throwable {
	    List<List<String>> getLoginList = dataTable.asLists(String.class);
	    String userLogin = getLoginList.get(1).get(0);
	    String passwordLogin = getLoginList.get(1).get(1);
	    loginPage.loginMarketplace(userLogin, passwordLogin);
	...
	public void i_should_validate_that_the_images_are_correct(DataTable dataTable)throws Throwable {
		...
		for(int i = 0; i < purchaseListBdd.size(); i++) {
			if(getSrcImg.get(i).equalsIgnoreCase(purchaseListBdd.get(i).get(count))) {
	...
	public void i_log_in_using_visual_user(DataTable dataTable)throws Throwable {
	    List<List<String>> getLoginList = dataTable.asLists(String.class);
	    String userLogin = getLoginList.get(1).get(0);
	    String passwordLogin = getLoginList.get(1).get(1);
	    loginPage.loginMarketplace(userLogin, passwordLogin);
	...
	public void i_should_validate_that_the_cart_are_correct_position()throws Throwable {
		boolean posicaoElemento = ecommerceList.validarPosicaoCart();
		if(posicaoElemento == true) {
			Assert.assertTrue("O elemento está na posicao correta", posicaoElemento);
		}else {
			Assert.assertTrue("O elemento NÃO está na posicao correta", posicaoElemento);
		}
	}
	...
	public void i_login_using_visual_user(DataTable dataTable)throws Throwable {
	    List<List<String>> getLoginList = dataTable.asLists(String.class);
	    String userLogin = getLoginList.get(1).get(0);
	    String passwordLogin = getLoginList.get(1).get(1);
	    loginPage.loginMarketplace(userLogin, passwordLogin);
	...
	public void i_put_a_product_to_the_cart(DataTable dataTable)throws Throwable {
		List<List<String>> productsList = dataTable.asLists(String.class);
		ecommerceList.selecionarProdutosLista(productsList);
		int qtdProdutoCarrinho = ecommerceList.obterQtdProdutosAddCarrinho();
		Assert.assertEquals(productsList.size(), qtdProdutoCarrinho);
	...
	public void i_should_validate_that_the_checkout_button_are_in_correct_position()throws Throwable {
		boolean posicaoElemento = ecommerceList.validarPosicaoBotao();
		if(posicaoElemento == true) {
			Assert.assertTrue("O elemento está na posicao correta", posicaoElemento);
		}else {
			Assert.assertTrue("O elemento NÃO está na posicao correta", posicaoElemento);
